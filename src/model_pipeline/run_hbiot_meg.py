...
def extract_paths(model_name):
    ...
    if os.path.basename(model_name) == "transformer.ckpt":
        config_path = "./utils_biot/config/hparams_meg.yaml"
        checkpoint_path = model_name
        reference_channels_path = "./utils_biot/config/reference_channels_meg.pkl"

    elif os.path.basename(model_name) == "hbiot.ckpt":
        config_path = "./utils_biot/config_hbiot/hparams_meg.yaml"
        checkpoint_path = model_name
        reference_channels_path = "./utils_biot/config_hbiot/reference_channels_meg.pkl"
